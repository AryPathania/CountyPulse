...
describe('ProfilePage', () => {
  ...
  it('renders the subtitle', () => {
    mockGetProfile.mockResolvedValue(MOCK_PROFILE)
    renderProfilePage()
    expect(screen.getByText('Manage your profile information and entries')).toBeInTheDocument()
  })
  ...
  it('populates ProfileForm with loaded data', async () => {
    ...
    expect(screen.getByTestId('input-headline')).toHaveValue('Senior Software Engineer')
  ...
  it('renders profile form section with correct testid', () => {
    mockGetProfile.mockResolvedValue(MOCK_PROFILE)
    renderProfilePage()
    expect(screen.getByTestId('profile-form-section')).toBeInTheDocument()
  })

  it('renders profile entries section with correct testid', () => {
    mockGetProfile.mockResolvedValue(MOCK_PROFILE)
    renderProfilePage()
    expect(screen.getByTestId('profile-entries-section')).toBeInTheDocument()
  })
