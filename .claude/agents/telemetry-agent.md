...
description: Telemetry and evaluation specialist for LLM logging and fine-tuning data collection. Use when implementing telemetry, metrics, or evaluation harnesses.
tools: Read, Edit, Write, Bash, Glob, Grep
skills: telemetry-finetune
---
