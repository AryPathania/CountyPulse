---
name: ui-agent
description: UI implementation specialist for React components, screens, and frontend logic. Use for any frontend/UI-related tasks.
tools: Read, Edit, Write, Bash, Glob, Grep
skills: shared-bullet-editor, tanstack-query, repo-conventions
---
