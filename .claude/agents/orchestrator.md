---
name: orchestrator
description: Coordinator agent for the ODIE MVP. Use for planning work, assigning tasks to specialized agents, and ensuring quality gates pass. Read-only - does not modify code.
