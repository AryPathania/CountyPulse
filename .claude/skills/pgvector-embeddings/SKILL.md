...
description: pgvector embeddings and similarity search patterns. Use when implementing semantic search, bullet matching, or vector-based retrieval.
---

# pgvector Embeddings + Simple Retrieval
