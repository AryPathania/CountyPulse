...
description: Repository conventions for DRY code, shared components, and project structure. Use when writing new code or refactoring existing code.
---

# Repo Conventions (DRY-first)
