---
name: tanstack-query
description: TanStack Query patterns for server state management. Use when implementing data fetching, caching, or state management in React components.
---

# TanStack Query vs Redux (the DRY approach)
