---
name: playwright-e2e
description: Playwright E2E testing patterns and best practices. Use when writing end-to-end tests or adding test selectors.
---

# Playwright E2E Tests (LLM-friendly)
